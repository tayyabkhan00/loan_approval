...
The project uses Logistic Regression for binary classification and is deployed as an interactive Flask web app with a clean and professional user interface.
...
| Credit Score      | Creditworthiness score (300–850) |
